					...
					<table class="table table-striped">
						...
						<c:forEach items="${ listOfAccounts }" var="account">
							<tr>
								...
								<td><a
									href="adminDeleteAccount?accountId=${ account.accountId }">delete</a></td>
								<td><a
									href="adminUpdateAccount?accountId=${ account.accountId }">update</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
				...
				<table class="table table-sm table-striped">
					...
					<c:forEach items="${ listOfCustomers }" var="customer">
						<tr>
							...
							<td><a
								href="adminDeleteCustomer?customerId=${ customer.customerId }">delete</a></td>
							<td><a
								href="adminUpdateCustomer?customerId=${ customer.customerId }">update</a></td>
						</tr>
					</c:forEach>
				</table>
			</div>
					...
					<table class="table table-striped">
						...
						<c:forEach items="${ listOfBranches }" var="branch">
							<tr>
								...
								<td><a
									href="adminDeleteBranch?branchId=${ branch.branchId }">delete</a></td>
								<td><a
									href="adminUpdateBranch?branchId=${ branch.branchId }">update</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
